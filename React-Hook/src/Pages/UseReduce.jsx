    ...
    <section>
      <div className="container mx-auto ">
        <div>
          ...
          <button
            onClick={() => dispatch({ type: "dicrement", value: 1 })}
          ...
          <button
            onClick={() => dispatch({ type: "dicrement", value: 5 })}
            className="bg-green-300 mx-3"
          >
            Decrement 5
          </button>
        ...
        <div>
          ...
          <button
            onClick={() => dispatch({ type: "dicrement2", value: 1 })}
            className="bg-green-300 mx-3"
          >
            Decrement2 1
          </button>
          ...
          <button
            onClick={() => dispatch({ type: "dicrement2", value: 5 })}
            className="bg-green-300 mx-3"
          >
            Decrement2 5
          </button>
